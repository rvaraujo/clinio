...
export default class Appointment extends React.Component {
    ...
    componentDidMount(){
        ...
        let patientInfo = PatientService.getPatientInfo(this.props.patientId);

         this.setState({ currentPatient: patientInfo.patient,
                      currentToothStatus: patientInfo.toothStatus,
                      preExistingProcedures:patientInfo.preExistingProcedures,
                      performedProcedures: patientInfo.performedProcedures,
                      procedures: patientInfo.procedures,
                    });
    }

    componentWillReceiveProps(nextProps){
        let patientInfo = PatientService.getPatientInfo(nextProps.patientId);
        this.setState({ currentPatient: patientInfo.patient,
            currentToothStatus: patientInfo.toothStatus,
            preExistingProcedures:patientInfo.preExistingProcedures,
            performedProcedures: patientInfo.performedProcedures,
